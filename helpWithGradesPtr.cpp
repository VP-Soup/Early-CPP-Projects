...
Date: 3/29/2020
Section: 3363-0008
Assignment: Pointer version: Help With The Grading Program
Due Date: 3/29/2020
About this project: Transform Help With The Grading Program to one that uses pointers for all parameters
...
int main()
{
    ...
    do
    {
        ...
        {
            int gradesize=grades[1].size();
            RemoveGrades(students, grades, &gradesize);
        }
...
int getValidGrade(int *gradeptr)
{
    while (*gradeptr<0 || *gradeptr>100)
    {
...
void RemoveGrades (string *students, vector<int> *grades, int *GradeSize)
{
    ...
    int targetPosition = getValidAssignmentNumber(GradeSize)-1;
